            ...
            {data.map((item, index) => {
              return (
                ...
                >
                  ...
                  {index === current && (
                    <p className="review-info-container-text">{item.text}</p>
                  )}
                  {index === current && (
                    <h4 className="review-info-container-name">{item.name}</h4>
                  )}
                  {index === current && (
                    <h5 className="review-info-container-title">
                      {item.title}
                    </h5>
                  )}
                </div>
        ...
        <div className="review-heading-right">
          {data.map((item, index) => {
            return (
              <div
                key={item.id}
                className={`review-image ${index === current ? "review-slide active" : "review-slide"
                  }`}
              >
