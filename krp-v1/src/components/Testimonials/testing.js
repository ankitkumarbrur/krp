          ...
          <div className="review-info">
            {data.map((item, index) => {
              return (
                ...
                >
                  <div className="review-info-quote"></div>
                  <p className="review-info-text">{item.text}</p>
                  <h4 className="review-info-name">{item.name}</h4>
                  <h5 className="review-info-title">{item.title}</h5>
                </div>
              );
            })}
